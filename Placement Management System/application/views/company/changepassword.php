...
<div class="wrapper">
  ...
  <nav class="main-sidebar sidenav  sidebar-light-primary navbar-vertical  " id="sidenav-main">
    ...
    <div class="scrollbar-inner">
            ...
            <div class="navbar-inner  align-items-center ">
                <ul class="navbar-nav flex-column ml-2 mr-2 pt-1">
                    ...
                    <li class="nav-item mt-1 mb-1">
                        <a href="<?= base_url().'company/changepassword/index';?>" class="nav-link pt-2 pb-2 rounded active">
    ...
    <span class=" position-fixed pb-6 bg-success " style="top:0px ; height:55%; width: 100%;">
    </span>
        ...
        <div class="row col-12 pt-2" style="margin-left:0px; margin-top: 90px;">
          <div class="col-md-12">
            ...
            <div class="card " >
              <div class="card-header" style="background-color: #565656;">
                <span class="card-title text-white mb-0">Change Password</span>
              </div>
              <form action="<?= base_url().'company/changepassword/changePassword' ; ?>" name="changePasswordForm" id="changePasswordForm" method="POST" autocomplete="off">
                <div class="card-body">
