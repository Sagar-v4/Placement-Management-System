...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-4 table-responsive">
                        <div class="card mx-1 px-2 my-2">
                            ...
                            <div class="px-4 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <label for="post" class="form-control-label">Total Pass Candidates</label>
                                        <div class="mb-3">
            ...
            <form action="<?= base_url().'company/ExamResult/interviewCall/'.$requirement['company_requirement_id'].'/'.$requirement['company_id']; ?>" name="intCallForm" id="intCallForm" method="POST" role="form " autocomplete="off">
            <input type="submit" class="btn text-white m-2" id="submit" style="background-color: #565656;" name="submit" value="Update Interview Call" >
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <?php if ( !empty($studentPassInfos) ) { $i = 0; foreach ($studentPassInfos as $studentData) { ?> 
                            ...
                            <tr >
                                <th scope="row"><?= $i+1 ;?></th>
                                <td><input type="checkbox" id="intCall" name="<?= $studentData[1]['exam_pass_id'];?>" value="<?= $studentData[1]['exam_pass_id'];?>" <?= ($studentData[1]['pms_interview_call'] == 1) ? 'checked' : '' ;?>></td>
                                <td class="p-1">
                                ...
                                <td><?= $studentPassed[$i]['total_correct_ans'] ;?></td>
