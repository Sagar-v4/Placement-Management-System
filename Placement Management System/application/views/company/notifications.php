    ...
    <div class="scrollbar-inner">
            ...
            <div class="navbar-inner  align-items-center ">
                <ul class="navbar-nav flex-column ml-2 mr-2 pt-1">
                    ...
                    <li class="nav-item mt-1 mb-1">
                        <a href="<?= base_url().'company/notifications/index';?>" class="nav-link pt-2 pb-2 rounded active">
            ...
            <div class="card table-responsive bg-white "  >
                ...
                <table class="table table-hover " >
                    ...
                    <?php if ( !empty($notifications) ) { rsort($notifications); foreach ($notifications as $notification) { ?>
                        <tr>
                            <td scope="row" class="px-1 py-2 <?= ($notification['company_notification_seen'] != 1) ? 'bg-gray-light' : 'bg-white' ; ?> " >
                            
                                <div class="media ml-1 align-items-center">
                                    <i class="<?= $notification['company_notification_class']; ?> px-3 " style="transform: scale(1.5, 1.5);"></i>
                                    <div class="media-body mx-2">
                                        <span class=" text-sm"><?= $notification['company_notification_detail']; ?><h6><?= $notification['time']?></h6></span>
                                    </div>
                                </div>
