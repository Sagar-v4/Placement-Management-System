    ...
    <div class="scrollbar-inner">
            ...
            <div class="navbar-inner  align-items-center ">
                <ul class="navbar-nav flex-column ml-2 mr-2 pt-1">
                    ...
                    <li class="nav-item mt-1 mb-1">
                        <a href="<?= base_url().'company/exams/index';?>" class="nav-link pt-2 pb-2 rounded active">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                    <div class="card ">
                        ...
                        <div class="card-body example" style="max-height:150px; overflow:auto; ">
                            <p class=" card-text mb-0"><strong>Exam Date : </strong><?= date('d-m-Y',strtotime($requirement['company_requirement_exam_date'])) ;?></p>
                            <p class=" card-text mb-0"><strong>Exam Time : </strong><?= date('h:i A',strtotime($requirement['company_requirement_exam_date'])) ;?> to <?= date('h:i A',strtotime($requirement['company_requirement_exam_date_end'])) ;?></p>
                        </div>
                        <div class="row card-body" id="resultBlockGone<?= $i;?>">
                            <div class="col-6 text-left">
                                <button type="button" class="col-11 btn btn-sm <?= ($requirement['company_requirement_exam_status'] == 1) ? 'btn-primary' : 'btn-default' ;?> " data-toggle="modal" data-target="#modal-requirement<?= $i;?>">Edit</button>
                            </div>
                            <div class="col-6 text-right">
                                <a href="<?= base_url().'company/ExamConduct/index/'.$requirement['company_requirement_id'].'/'.$requirement['company_id']  ;?>" target="_blank" class="col-11 btn btn-outline-primary btn-sm">Conduct</a>
                            </div>
                        </div>
                        
                        <div class="row card-body" style="display: none;" id="resultBlock<?= $i;?>">
                            <div class="col-12 text-center">
                                <a id="result<?= $i;?>"  href="<?= base_url().'company/ExamResult/index/'.$requirement['company_requirement_id'].'/'.$requirement['company_id']  ;?>" target="_blank" class="col-8 btn btn-primary btn-sm">Result</a>
                            </div>
                        </div>

                        
                        <script type="text/javascript" >
                            var countDownDateExam<?= $i;?> = new Date('<?= date($requirement['company_requirement_exam_date_end'])?>').getTime();
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="card bg-secondary border-0 mb-0">
                                    <div class="card-body px-lg-10 py-lg-10">
                                        ...
                                        <form action="<?= base_url().'company/View/requirementExamUpdate/'.$requirement['company_requirement_id'] ; ?>" name="registrationForm" id="registrationForm" method="POST" role="form text-left" autocomplete="off">
                                            <div class="p-lg-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="date_exam_end" class="form-control-label">End Time <span class="text-danger">*</span></label>
                                                    <input type="datetime-local" required class="form-control time mb-3" value="<?= date('Y-m-d\TH:i', strtotime($requirement['company_requirement_exam_date_end'])) ;?>" name="date_exam_end" id="date_exam_end<?= $j;?>">
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-7 text-right">
                                                        <!-- <input type="submit" id="submit<? //echo $j++;?>" name="" class="btn bg-primary w-20 mb-2 text-white"> -->
                                                        <a href="<?= base_url().'company/Exams/activation/'.$requirement['company_requirement_id'] ; ?>" type="button" class="btn bg-default w-20 mb-2 text-white"><?= ($requirement['company_requirement_exam_status'] == 1) ? 'Deactivate' : 'Activate' ;?></a>
                                                    </div>
                                                </div>
