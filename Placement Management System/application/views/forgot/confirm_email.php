          ...
          <div class="col-xl-4 col-lg-5 col-md-8 col-sm-10 d-flex flex-column mx-auto">
            ...
            ?>
              ...
              <div class="card-body">
                ...
                <form action="<?= base_url().'forgot/confirm_email/send_otp'; ?>" name="loginForm" id="loginForm" method="POST" role="form text-left" autocomplete="off">
                  
                  <label for="email" class="form-control-label">Email</label>
                  <div class="mb-3">
                    <input type="email"  name="email" id="email" class="form-control <?= form_error('email') ? 'is-invalid' : '';?>" value="<?= set_value('email');?>" placeholder="Email" aria-label="Email" aria-describedby="email-addon" />
                  </div>
