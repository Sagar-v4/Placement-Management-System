...
<body class="control-sidebar-slide-open mt-0 layout-fixed g-sidenav-show g-sidenav-pinned ">
...
<div class="wrapper">
  ...
  <nav class="main-sidebar sidenav  sidebar-light-primary navbar-vertical  " id="sidenav-main">
    ...
    <div class="scrollbar-inner">
            ...
            <div class="navbar-inner  align-items-center ">
                ...
                <li class="nav-item mt-3 mb-1" >
                        <a href="<?= base_url().'student/home/index';?>" class="nav-link pt-2 pb-2 rounded active">
    ...
    <div class="content-wrapper" >
        <div class=" position-fixed pb-6 bg-primary " style="top:0px ; height:55%; width: 100%;">
        </div>
                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-6 text-left">
                            ...
                            <?php if ( $requirement['company_requirement_min_percentage_12th'] <= $userInfo['r12'] and ( $requirement['company_requirement_min_percentage'] <= $userInfo['percentage_h'] or $requirement['company_requirement_min_cgpa'] <= $userInfo['cgpa_h'] ) ) { ?>
                                ...
                                <a id="cr<?= $requirement['company_requirement_id'];?>" href="<?= base_url().'student/home/apply/'.$requirement['company_id'].'/'.$requirement['company_requirement_id'].'/'.$userInfo['sid'] ;?>" type="button" class=<?= ( $requirement['status'] == 1 ) ? '"col-11 btn btn-sm btn-default"' : '"col-11 btn btn-sm btn-primary"' ; ?>><?= ( $requirement['status'] == 1 ) ? 'Revoke' : 'Apply' ; ?></a>
                                
                            <?php } else { ?>
                            
                                <button type="button" disabled class="col-11 btn btn-sm btn-primary "><a href="#" style="pointer-events: none" class="text-white">Apply</a></button=>
                            ...
                            <?php } ?>
                                ...
                                <script type="text/javascript" >
                                    var countDownDate = new Date('<?= date($requirement['company_requirement_last_date'])?>').getTime() + 24 * 60 * 60 * 1000;
                                    ...
                                    if (distance < 0) {
                                        document.getElementById("cr<?= $requirement['company_requirement_id'];?>").style.backgroundColor = "#f5365c";
                                        document.getElementById("cr<?= $requirement['company_requirement_id'];?>").style.borderColor = "#f5365c";
                                        document.getElementById("cr<?= $requirement['company_requirement_id'];?>").style.pointerEvents = "none";
                                    }
                                        
                                </script>

                        <div class="col-6 text-right">
                            <button type="button" class="col-11 btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modal-requirement<?= $i++;?>">Details</button>
                        </div>
