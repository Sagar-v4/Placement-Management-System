      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url().'admin/addnewstudent/index';?>" class="nav-link active">
                  <i class="nav-icon fa fa-plus"></i>
                  <p>Add New</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
                ...
                <?php
                if ( !empty($this->session->flashdata('signupSMsg')) ) {
                  echo "
                  <div class='alert alert-danger alert-dismissible'>
                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                    <i class='icon fas fa-ban'></i>
                    ".$this->session->flashdata('signupSMsg')."
                  </div>";
                }

                if ( !empty($this->session->flashdata('signuplogSMsg')) ) {
                  echo "
                  <div class='alert alert-success alert-dismissible'>
                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                    <i class='icon fas fa-check'></i>
                    ".$this->session->flashdata('signuplogSMsg')."
                  </div>";
                }           
              ?>
            ...
            <div class="card card-primary">
              ...
              <form action="<?= base_url().'admin/addnewstudent/authenticate'; ?>" name="studentRegistrationForm" id="studentRegistrationForm" method="POST" autocomplete="OFF">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('first_name') ? 'is-invalid' : '';?>" value="<?= set_value('first_name'); ?>" id="first_name" name="first_name" placeholder="Student name">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('middle_name') ? 'is-invalid' : '';?>" value="<?= set_value('middle_name'); ?>" id="middle_name" name="middle_name" placeholder="Father's name">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('last_name') ? 'is-invalid' : '';?>" value="<?= set_value('last_name'); ?>" id="last_name" name="last_name" placeholder="Surname">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label class="<?= form_error('gender') ? 'text-danger' : '';?>">Gender <span class="text-danger">*</span></label>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" value="male" id="male" name="gender" <?php if(set_value('gender') == "male") echo "checked";?>>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" value="female" id="female" name="gender" <?php if(set_value('gender') == "female") echo "checked";?>>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <div class="custom-control custom-radio">
                          <input class="custom-control-input" type="radio" value="other" id="other" name="gender"<?php if(set_value('gender') == "other") echo "checked";?>>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control <?= form_error('dob') ? 'is-invalid' : '';?>" value="<?= set_value('dob');?>" name="dob" id="dob" type="date">
                  </div>  
