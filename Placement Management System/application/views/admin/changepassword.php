    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php } ?>
          <li class="nav-item">
            <a href="<?= base_url().'admin/changepassword/index';?>" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
                ...
                <?php
                if ( !empty($this->session->flashdata('msgaf')) ) {
                  echo "
                  <div class='alert alert-danger alert-dismissible'>
                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                    <i class='icon fas fa-ban'></i>
                    ".$this->session->flashdata('msgaf')."
                  </div>";
                }

                if ( !empty($this->session->flashdata('msgas')) ) {
                  echo "
                  <div class='alert alert-success alert-dismissible'>
                    <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                    <i class='icon fas fa-check'></i>
                    ".$this->session->flashdata('msgas')."
                  </div>";
                }           
              ?>
            ...
            <div class="card card-primary">
              ...
              <form action="<?= base_url().'admin/changepassword/changePassword' ; ?>" name="changePasswordForm" id="changePasswordForm" method="POST" autocomplete="off">
                <div class="card-body">

                  <div class="form-group">
                    <label for="email" >Email <span class="text-danger">*</span></label>
                    <input type="email" class="form-control <?= form_error('email') ? 'is-invalid' : '';?>" disabled value="<?= (empty(set_value('email'))) ? $userInfo['email'] : set_value('email') ;?>" name="email" id="email" placeholder="Email">
                  </div>
                  ...
                  <div class="card-footer">
                    <input type="submit" class="btn btn-primary" id="submit" name="Change Password" >
                  </div>
