...
! function (e, t) {
    ...
    var U = "Dropdown1",
        ...
        G = function () {
            ...
            return t.toggleSubmenu = function () {
                this._element.siblings().show().toggleClass("show"), this._element.next().hasClass("show") || this._element.parents(W).first().find(".show").removeClass("show").hide(), this._element.parents("li.nav-item.dropdown1.show").on("hidden.bs.dropdown1", (function () {
                    n.default(".dropdown1-submenu .show").removeClass("show").hide()
                }))
            }, t.fixPosition = function () {
                var e = n.default(".dropdown1-menu.show");
                if (0 !== e.length) {
                    e.hasClass("dropdown1-menu-right") ? e.css({
                        left: "inherit",
                        right: 0
                    }) : e.css({
                        left: 0,
    ...
    n.default('.dropdown1-menu [data-toggle="dropdown1"]').on("click", (function (e) {
        e.preventDefault(), e.stopPropagation(), G._jQueryInterface.call(n.default(this), "toggleSubmenu")
    })), n.default('.navbar [data-toggle="dropdown1"]').on("click", (function (e) {
        e.preventDefault(), n.default(e.target).parent().hasClass("dropdown1-submenu") || setTimeout((function () {
    ...
    var de = "lte.iframe",
        ...
        Te = ".main-header a.dropdown1-item",
        je = "iframe-mode",
        ...
        Qe = function () {
            ...
            return t.onTabClick = function (e) {
                ...
                var t = n.default(Ie + '[href$="' + e + '"]'),
                    a = n.default('.main-header a.dropdown1-item[href$="' + e + '"]'),
    ...
    }, e.CardRefresh = f, e.CardWidget = I, e.ControlSidebar = M, e.DirectChat = P, e.Dropdown1 = G, e.ExpandableTable = te, e.Fullscreen = re, e.IFrame = Qe, e.Layout = Me, e.NavbarSearch = Ct, e.PushMenu = Ke, e.SidebarSearch = ht, e.Toasts = kt, e.TodoList = Dt, e.Treeview = $t, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));
